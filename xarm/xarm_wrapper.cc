...
namespace XArmWrapper
{
	...
	bool __stdcall is_connected(void)
	{
		return arm->is_connected();
	}

	//int __stdcall register_connect_changed_callback(ConnectChangedCallback Callback)
	//{
	//	return arm->register_connect_changed_callback(Callback);
	//}
}
