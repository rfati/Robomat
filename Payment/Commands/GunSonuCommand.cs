...
namespace Payment.Commands
{
    ...
    public class GunSonuCommand : CardReaderCommand
    {
        public GunSonuCommand()
        {
    ...
    public class GunSonu
    {
        ...
        public string SlipType = "SettleDetail";  // Customer, Merchant, Both, SettleSummary, SettleDetail
    }
}
