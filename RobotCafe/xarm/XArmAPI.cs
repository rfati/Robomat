...
namespace RobotCafe.xarm
{
    class XArmAPI
    {
        ...
        public string dllLocation = Environment.CurrentDirectory + "\\xarm.dll";
        ...
        //public delegate void ConnectChangedCallback(bool connected, bool reported);

        //[DllImport("xarm.dll", CallingConvention = CallingConvention.StdCall)]
        //public static extern int register_connect_changed_callback(ConnectChangedCallback connectChangedCallback);

        //[DllImport("xarm.dll")]
        //public static extern int release_connect_changed_callback(ConnectChangedCallback connectChangedCallback = null);

        [DllImport("xarm.dll")]
        public static extern bool is_connected();
